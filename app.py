...
def home():
    if request.method == "POST":
       ...
       if first_name == "myuserid" and password == "mypass":
...
def predict():
     ...
     if request.method == 'POST':
            ...
            if (prediction[0] > 0.9):
                return render_template('Loan_App_Template.html', prediction_text='Result: Highly Loan Eligible')
                
            elif (prediction[0] > 0.5):
            	return render_template('Loan_App_Template.html', prediction_text='Results: Basic Loan Eligible')
	    
            else:
                return render_template('Loan_App_Template.html', prediction_text= 'RESULTS:  Loan Not Eligible')
